...
final class Version20250715122622 extends AbstractMigration
{
    ...
    {
        return 'Create session table with host, name, code, description, is_active, max_participants, and ended_at fields,
            and create session_participant table with session_id, pseudo, is_active, left_at fields'
        ;
    }
